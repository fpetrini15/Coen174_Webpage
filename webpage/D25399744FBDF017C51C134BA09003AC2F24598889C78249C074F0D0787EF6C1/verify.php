...
function checkDB($First, $Last, $year, $major){
    ...
    echo "<font color='black' size=5> <pre> <strong>First Name</strong>:\t$row[0] </pre> </font>";
		echo "<font color='black' size=5> <pre> <strong>Last Name</strong>:\t$row[1] </pre> </font>";
		echo "<font color='black' size=5> <pre> <strong>Grad Year</strong>:\t$row[2] </pre> </font>";
    echo "<font color='black' size=5> <pre> <strong>Major</strong>:\t\t$row[3] </pre> </font>";
   }
   else{
